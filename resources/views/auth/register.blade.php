                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="jk" id="jenis-kelamin" class="form-control @error('jk') is-invalid @enderror">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telepon" type="text" class="form-control @error('telp') is-invalid @enderror" name="telp"  value="{{ old('telp') }}" required autocomplete="telp">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" id="alamat" cols="30" rows="5" required autocomplete="alamat" class="form-control @error('alamat') is-invalid @enderror" value="{{ old('email') }}"></textarea>
