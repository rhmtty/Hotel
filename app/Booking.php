...
class Booking extends Model
{
    ...
    public function scopeEditBooking($query, $id)
    {
        return $query->join('kamar', 'bookings.id_kamar', '=', 'kamar.id')
            ...
            ->select('bookings.*', 'kamar.no_kamar as nomer_kamar', 'kamar.lantai as lantai_kamar', 'kamar.blok_id as nama_blok', 'kamar.tipe as tipe_kamar', 'kamar.harga as harga_kamar', 'kamar.fasilitas as fasilitas_kamar', 'pelanggan.no_ktp as ktp_pelanggan', 'pelanggan.customer_name as nama_pelanggan', 'pelanggan.customer_email as email', 'pelanggan.customer_phone as telp_pelanggan', 'pelanggan.customer_address as alamat_pelanggan')
            ->first();
    }
    ...
    public function scopeInvoice($query, $invoice = '')
    {
        return $query->join('kamar', 'bookings.id_kamar', '=', 'kamar.id')
            ...
            ->join('pelanggan', 'bookings.id_pelanggan', '=', 'pelanggan.id')
            ->where('bookings.invoice', $invoice)
            ->select('bookings.*', 'kamar.no_kamar as nomer_kamar', 'kamar.lantai as lantai_kamar', 'kamar.blok_id as nama_blok', 'kamar.tipe as tipe_kamar', 'kamar.harga', 'kamar.fasilitas as fasilitas_kamar', 'pelanggan.no_ktp as ktp_pelanggan', 'pelanggan.customer_name as nama_pelanggan', 'pelanggan.customer_phone', 'pelanggan.customer_address as alamat_pelanggan', 'pelanggan.customer_email')
            ->first();
    }
